...
from data_preparation.xml_parser import countTags, collectAllTags, extractAttributeElem, extractTagElem, extractAttributesTag
...
class AnnotationEncoder:
    ...
    def __init__(self, dir_annotations, warning= False):
        ...
        self.namespaces_label = collectAllTags(self.files, warning)
